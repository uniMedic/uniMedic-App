...
module.exports.templates = {
  replies: {
    intro: [
      "Comencemos una nueva investigación! \n\nEnvíame una tomografía computarizada, una radiografía o cualquier otra imagen médica y hablemos al respecto!",
    ],
    on_task: [
  ...
  messages: {
    ...
    on_invalid_input: {
      title: "Error",
      description: "Sube una imagen médica!",
    },
  },
  router_labels: {
